...
def test(
    ...
    **kwargs,
    ...
    """
    # raise ValueError(f"metrics: {metrics}")
    trainer = Trainer(
        model,
        physics=physics,
    ...
    out = trainer.test(test_dataloader, save_path=save_folder,essential_parameter_dict = essential_parameter_dict, plot_images=plot_images)
