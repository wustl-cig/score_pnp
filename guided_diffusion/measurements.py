...
class ColorizationOperator(LinearOperator):
    ...
    def forward(self, data, **kwargs):
        # raise ValueError(f"Check the image shape data.shape: {data.shape}")
        # print(f"")
...
class NonlinearBlurOperator(NonLinearOperator):
    def __init__(self, opt_yml_path, device):
        self.device = device
        # raise ValueError(f"opt_yml_path: {opt_yml_path}")
    ...
    def prepare_nonlinear_blur_model(self, opt_yml_path):
        ...
        with open(opt_yml_path, "r") as f:
            ...
            # raise ValueError(f"opt: {opt} / model_path: {model_path}")
