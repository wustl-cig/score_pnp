...
def second_dpir(noise_level_img, max_iter, denoising_strength_sigma_at_begin, denoising_strength_sigma_at_end, lamb, gamma, zeta,
    ...
    print(f"# ------------")
    print(f"# {iterative_algorithms}({denoiser_network_type})- configuration: num_iters: {max_iter} / lambda: {lamb}")
